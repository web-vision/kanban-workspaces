...
export class BoardRenderer {
  ...
  createCardHTML(card) {
    ...
    const dueDateHTML = card.dueDate
      ? `<div class="card-due-date ${(this as any).isDueDateOverdue(card.dueDate) ? "overdue" : ""}">
  ...
  renderFilters() {
    ...
    Object.entries(this.board.data.filters).forEach(([filterType, filterConfig]: [string, any]) => {
