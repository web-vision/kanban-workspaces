...
in the card preview Checklist tab. Checked state is per card × stage × item.
...
* ``preview-modal.ts`` — Checklist tab for interactive items; Activity tab shows stage
  moves and checklist check/uncheck comments.
