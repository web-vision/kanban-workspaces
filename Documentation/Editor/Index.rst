...
You can also open the card preview and use the **Checklist** tab to check or uncheck items for any stage that already has a template or saved state. Check/uncheck actions are recorded in the card **Activity** tab (same stream as stage moves and comments).
