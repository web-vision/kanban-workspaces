...
> type Kanban Workspaces is in compliance with Regulation (EU) 2024/2847.
>
> The full text of the EU declaration of conformity is available at the
> following internet address:
> https://security.web-vision.de/conformity/web-vision/kanban-workspaces/0.1.0/en/
...
This extension is released under the [GPL-2.0-or-later](LICENSE.txt) license.
